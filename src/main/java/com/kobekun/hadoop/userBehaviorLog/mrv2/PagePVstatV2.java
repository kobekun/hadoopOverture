...
public class PagePVstatV2 {
    ...
    public static void main(String[] args) throws Exception{
        ...
        Path outputpath = new Path("output/v2/pagepvstat");
        ...
        job.setJarByClass(PagePVstatV2.class);
        ...
        FileOutputFormat.setOutputPath(job,new Path("output/v2/pagepvstat"));
