...
public class NativeIO {
    public static class POSIX {
        ...
        public static class CacheManipulator {
            ...
            public void posixFadviseIfPossible(String identifier,
                ...
                org.apache.hadoop.io.nativeio.NativeIO.POSIX.posixFadviseIfPossible(identifier, fd, offset,
                        len, flags);
            }
    ...
    public static FileInputStream getShareDeleteFileInputStream(File f, long seekOffset)
        ...
        if (!Shell.WINDOWS) {
            ...
            // given offset.
            //
            FileDescriptor fd = org.apache.hadoop.io.nativeio.NativeIO.Windows.createFile(
                    f.getAbsolutePath(),
                    org.apache.hadoop.io.nativeio.NativeIO.Windows.GENERIC_READ,
                    org.apache.hadoop.io.nativeio.NativeIO.Windows.FILE_SHARE_READ |
                            org.apache.hadoop.io.nativeio.NativeIO.Windows.FILE_SHARE_WRITE |
                            org.apache.hadoop.io.nativeio.NativeIO.Windows.FILE_SHARE_DELETE,
                    org.apache.hadoop.io.nativeio.NativeIO.Windows.OPEN_EXISTING);
            if (seekOffset > 0)
                org.apache.hadoop.io.nativeio.NativeIO.Windows.setFilePointer(fd, seekOffset, org.apache.hadoop.io.nativeio.NativeIO.Windows.FILE_BEGIN);
            return new FileInputStream(fd);
        }
    }
    ...
    public static FileOutputStream getCreateForWriteFileOutputStream(File f, int permissions)
        ...
        if (!Shell.WINDOWS) {
            ...
            try {
                FileDescriptor fd = org.apache.hadoop.io.nativeio.NativeIO.POSIX.open(f.getAbsolutePath(),
                        org.apache.hadoop.io.nativeio.NativeIO.POSIX.O_WRONLY | org.apache.hadoop.io.nativeio.NativeIO.POSIX.O_CREAT
                                | org.apache.hadoop.io.nativeio.NativeIO.POSIX.O_EXCL, permissions);
            ...
            try {
                FileDescriptor fd = org.apache.hadoop.io.nativeio.NativeIO.Windows.createFile(f.getCanonicalPath(),
                        org.apache.hadoop.io.nativeio.NativeIO.Windows.GENERIC_WRITE,
                        org.apache.hadoop.io.nativeio.NativeIO.Windows.FILE_SHARE_DELETE
                                | org.apache.hadoop.io.nativeio.NativeIO.Windows.FILE_SHARE_READ
                                | org.apache.hadoop.io.nativeio.NativeIO.Windows.FILE_SHARE_WRITE,
